...
(* Where the functor category comes from, and what it is for
   ...
   the governing principle is pointwise inheritance: when D has limits of a
   given shape, so does `[C, D]`, computed pointwise (Instance/Fun/Limit.v's
   [Functor_Category_pointwise_limit]; an incomplete D can have limits
