...
(* nLab: https://ncatlab.org/nlab/show/adjoint+functor+theorem
   ...
   ** READ THIS BEFORE READING ANYTHING ELSE
   ...
   3. "...nor its free object exists" — [FreeGrp], Instance/Grp/Free.v:525.
   4. The adjunction the issue asks to produce — [free_group_adjunction],
      Instance/Grp/Free.v:528, delivered by #298.
   5. GAFT's first hypothesis — [Grp_Complete], Instance/Grp/Limit.v:706.
   6. GAFT's second — [Grp_Forget_continuous], Instance/Grp/Limit.v:714.
   7. The Riehl §4.7 section's "NO concrete solution set is exhibited
      ...
      Adjunction/GAFT/Sets.v:155, hand-built with all four parameters
   ...
   ** THE SOLUTION SET IS NO LONGER CIRCULAR, AND THE OLD ONE IS KEPT
   ...
   That is the same honesty Instance/Rng/AFT.v:739 states for the ring
   case and Instance/Mod/TensorAFT.v:856 for the tensor: a term model is
   ...
   ** WHY MAC LANE'S OWN SOLUTION SET IS NOT USED
   ...
   Instance/Grp/Abelianization.v:128's [InCommutator] is the exact
   template — a `≈`-saturated inductive closure — and
   Instance/Grp/Quotient.v:236's [SubgroupGrp] is what it would feed.
   ...
   [Indiscrete@{uo}] instance.  Test/ProbeGrpFreeAFT442.v:250-299 carries
...
(* WHY THIS INDEX AND NOT A SIGMA OVER GROUPS.
   ...
   the same one Instance/Mod/TensorAFT.v:885 records.  [Set+1] is the sort
   ...
   costs nothing — Lib.v:17's [Unset Universe Minimization ToSet] keeps
...
(* MEASURED, side by side, [About] under [Set Printing Universes] with the
   ...
   SIX universes against NINE.  [SolutionSet@{i dobj cobj h}] (GAFT.v:179),
   ...
   Instance/Mod/TensorAFT.v:885 records at [RMod R], and it is the price of
...
(** ** Mac Lane §V.6's injectivity clause, and where its argument stops
    ...
    characteristic function of [a].  The Z/2 used is Instance/Grp.v:1188's
...
(* Non-vacuity, and the connection to what was already in tree.
   Instance/Grp/Free.v:680's [free_group_two_generators_distinct] is the
