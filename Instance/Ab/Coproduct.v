...
(* Book: Mac Lane, "Categories for the Working Mathematician" (2nd ed.),
   ...
   ([ab_cmon :> CMonObject], Instance/Ab.v:123) and — the load-bearing
   choice — defines [AbHom A B := CMonHom A B] as a bare [Definition]
   (Instance/Ab.v:194), with [Ab]'s hom-setoid, identity and composition
   ...
   [CMon_one] and [CMon_zero_hom] (Instance/Ab.v:252, :252).  So
   ...
   cause is located rather than guessed: Instance/Ab.v:241's [Ab_trivial]
   ...
   because Instance/CMon/Biproduct.v:73's [CMon_trivial@{o}] IS
...
(* The fact that makes the two [zero_mor] laws transfer: Ab's zero
   ...
   being [CMon_one] and [CMon_zero_hom] (Instance/Ab.v:252, :252) and
