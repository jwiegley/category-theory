...
(** * Spanning bilinear maps, and the solution set for the tensor product
    ...
    `representability_theorem` (Adjunction/Representability/Sets.v:307),
    ...
    a [Submodule] (Instance/Mod/Quotient.v:211) to a [SubObj]
    ...
    and the same argument, [rmod_monic_injective] (Instance/Mod.v:471)
    ...
    #448's categorical form (Adjunction/SpanningArrow.v:256) at the functor
    [Bilin V V'] (Instance/Mod/Tensor.v:784) and the global element
    ...
    [spanning_forces_top] (Adjunction/SpanningArrow.v:347, :361): the
    ...
    (Instance/Mod/Tensor.v:700) runs one level up -- and
    ...
    so [FactoringFamily] (Adjunction/SpanningArrow.v:388) does too, and
    ...
    obstruction Adjunction/SpanningArrow.v:216-225 records for
    ...
    [PreservesWidePullbacks] (Adjunction/SpanningArrow.v:271) for ANY
    ...
    Instance/Mod/Bimodule.v:676's [BalTensor] -- the genuinely balanced
    ...
    the records of Adjunction/GAFT.v:159 and Adjunction/Representability/
    Sets.v:233, and Adjunction/SpanningArrow.v:198-202 says the same of
    ...
    (Instance/Mod/Tensor.v:119-175 records that gap), so the
    ...
    [ImageSubmod_obligation_*]; those are Instance/Mod/Quotient.v:761's and
...
(* FIVE constructors, not four: [mgen_zero] cannot be dropped (P may be
   ...
   (Instance/Mod/Quotient.v:242) gets it from (−1)·a -- so there is no
   [mgen_neg]. *)
...
(* The image of a bilinear map, as a bare [Type]-valued predicate -- the
   membership shape of [ImageSubmod] (Instance/Mod/Quotient.v:761) with
...
(* Mac Lane's "A ⊗ B is spanned by the elements a ⊗ b", by induction on
   [MTerm] in five cases -- the same five [tensor_hom_ext]
   (Instance/Mod/Tensor.v:700) runs one level up.  The [mt_neg] case
