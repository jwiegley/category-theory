...
- `Structure/Dagger.v`, `Structure/Groupoid.v` (+ `Structure/Groupoid/*`), `Construction/Groupoid.v` (+ `Construction/Groupoid/Core.v`), `Construction/Fractions.v`, `Structure/Thin.v`: dagger categories, groupoids as a property with the connected-groupoid structure theorem, the core construction `Groupoid C` (the maximal subgroupoid), thin categories.
