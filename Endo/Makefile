...
# coq_makefile . ACompose.v Applicative.v Basics.v Category.v Conduit.v Cont.v CpdtTactics.v Either.v EitherT.v FCompose.v Functor.v Iso.v MCompose.v Monad.v Tuple.v 
#
