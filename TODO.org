...
* Coq improvements
** TODO variables arguments specifiers, to avoid @foo _ _ _ _ _ _
#+begin_src coq
Arguments Obj {_}, _.
...
#+end_src coq
** TODO Define dependent and non-dependent products using records
#+begin_src coq
...
* Theory
** TODO Faithful, Full, Fully Faithful functors (inj, surj, bi, resp.)
** Colimits
...
*** TODO and their conversions
*** TODO duality : F ⊣ G ⇒ Gop ⊣ F op
...
#+end_src
** TODO Show that the opposite the comma category of (Comma F G)
is isomorphic to the comma category (Comma Gᵒᵖ Fᵒᵖ)
** TODO Whenever F and F' are two naturally isomorphic functors
then (Comma F G) is isomorphic to (Comma F' G)
